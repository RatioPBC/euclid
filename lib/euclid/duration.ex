defmodule Euclid.Duration do
  ...
  def convert({_time, _from_unit} = duration, :minute), do: convert(duration, :second) |> Integer.floor_div(@seconds_per_minute)
  def convert({_time, _from_unit} = duration, :hour), do: convert(duration, :second) |> Integer.floor_div(@seconds_per_hour)
  def convert({_time, _from_unit} = duration, :day), do: convert(duration, :second) |> Integer.floor_div(@seconds_per_day)
